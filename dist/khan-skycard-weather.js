...
try {
  ...
  _buildStaticSVG() {
    ...
    this.shadowRoot.innerHTML = `<style>
      ...
      .kfc-wx-forecast{position:absolute;top:190px;left:50%;transform:translateX(-50%);width:64%;max-width:720px;min-width:560px;display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:10px;margin:0;padding:0;border:none;z-index:6;pointer-events:none}
     ...
     .kfc-wx-low{font-size:.9rem;opacity:.85;display:inline-block}
      ...
      @media (max-width:780px){.kfc-wx-temp{font-size:2.5rem}.kfc-wx-details{gap:7px;font-size:.52rem}.kfc-wx-forecast{left:50%;transform:translateX(-50%);width:82%;min-width:0;max-width:none;gap:5px}.kfc-wx-icon{font-size:1.25rem}}
    </style>
